            ...
            <div class="container"
						...
						<div class="header " style="padding-bottom: 5px">
							...
							<ul class="nav nav-pills pull-right">
								...
								<li class="active"><a
									href="<?php echo $helper->getLoginUrl (array("user_photos","public_profile"));?>">Login to Facebook</a></li>
							</ul>
							</nav>
							<h2 class="text-muted"><marquee direction="right" scrolldelay="20"><b>FACEBOOK CHALLANGE</b></marquee></h2>
						</div>
						<hr>
							<hr>
